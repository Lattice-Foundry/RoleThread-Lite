...
from ui.ui_edit_entries import apply_edit_entry_filters
...
def test_edit_search_applies_after_tag_filtering():
    pairs = [
...
def test_edit_blank_search_preserves_existing_tag_filter_behavior():
    pairs = [
...
def test_edit_search_scans_entries_outside_current_page():
    pairs = [
...
def test_edit_pagination_applies_after_search():
    pairs = [
...
def test_edit_search_no_results_is_safe():
