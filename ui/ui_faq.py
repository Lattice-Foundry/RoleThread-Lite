...
FAQ_CATEGORY_DESCRIPTIONS = {
    ...
    "Prompt Generation (Beta)": "Prompt compilation, provider-agnostic generation, and review workflows.",
...
_FAQ_PREFIX_CATEGORY_MAP = {
    ...
    "data generation": "Prompt Generation (Beta)",
    "prompt generation beta": "Prompt Generation (Beta)",
...
_FAQ_PREFIX_HELP_RELATED = {
    ...
    "prompt generation beta": ("data-generation",),
    "ai training fundamentals": (
